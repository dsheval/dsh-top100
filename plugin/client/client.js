...
function RankingsPage({ t }) {
	...
	const load = (0, react.useCallback)(async (nextView, nextQuery, offset = 0, append = false) => {
		setLoading(true);
		setErrorAction("load");
		setError(null);
		try {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			error ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					errorAction === "load" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						onClick: () => void load(view, query, 0, false),
						children: t("retry")
					}) : null
				]
			}) : null,
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: "list",
				children: [items.map((item) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("article", { children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "rank",
						children: [
							item.installable && !item.installed ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
								type: "checkbox",
								checked: selected.includes(item.fullName),
								disabled: busy !== null || selected.length >= 20 && !selected.includes(item.fullName),
								title: selected.length >= 20 && !selected.includes(item.fullName) ? t("batchLimit") : void 0,
								"aria-label": `${t("select")} ${item.fullName}`,
								onChange: () => toggleSelected(item.fullName)
							}) : null,
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: item.rank })
						]
					}),
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "actions",
						children: [jobsByName.get(item.fullName) ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: `job job-${jobsByName.get(item.fullName).phase}`,
							children: [
								t(`phase_${jobsByName.get(item.fullName).phase}`),
								jobsByName.get(item.fullName).lastLine ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("small", { children: jobsByName.get(item.fullName).lastLine }) : null,
								jobsByName.get(item.fullName).error ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("small", { children: jobsByName.get(item.fullName).error }) : null,
								!["installed", "failed", "cancelled"].includes(jobsByName.get(item.fullName).phase) ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									onClick: () => void cancelJob(jobsByName.get(item.fullName).id),
									children: t("cancel")
								}) : ["failed", "cancelled"].includes(jobsByName.get(item.fullName).phase) ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									disabled: busy !== null,
									onClick: () => void retryJob(jobsByName.get(item.fullName).id),
									children: t("retry")
								}) : null
							]
						}) : item.installed ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							disabled: true,
				...
				] }, `${item.fullName}-${item.rank}`)), !loading && items.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
					className: "lede",
					children: t("empty")
				}) : null]
			}),
			remaining > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
				type: "button",
				disabled: loading,
				onClick: () => void load(view, query, items.length, true),
				children: [
					t("more"),
					" (",
					remaining,
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							children: confirming.map((item) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [
