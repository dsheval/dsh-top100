...
export declare function fetchNpmLatest(name: string, forceRefresh?: boolean, selector?: string): Promise<string | null>;
/**
...
export declare function listManagedPlugins(profile: string, document: RankingsDocument | null, explicitDir?: string, refreshUpdates?: boolean): Promise<ManagedPlugin[]>;
