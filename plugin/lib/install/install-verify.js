...
async function verifyGitHub(spec) {
    ...
    const payload = await fetchJson(`https://api.github.com/repos/${owner}/${repo}/contents/package.json${query}`).catch(() => null);
    ...
    for (const candidate of candidates) {
        ...
        const child = await fetchJson(`https://api.github.com/repos/${owner}/${repo}/contents/${encodedPath}?ref=${encodeURIComponent(branch)}`).catch(() => null);
