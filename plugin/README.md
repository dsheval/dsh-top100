...
<p align="center">
  ...
  <a href="https://github.com/dsheval/dsh-top100/releases/tag/v1.3.4"><img alt="正式版本 v1.3.4" src="https://img.shields.io/badge/release-v1.3.4-2f6f68?style=flat-square"></a>
...
```sh
npx @deepseek-ai/dsh plugin --profile web add @dsheval/dsh-top100-plugin@1.3.4
...
minimumReleaseAgeExclude:
  - '@dsheval/dsh-top100-plugin@1.3.4'
```
...
```sh
npx @deepseek-ai/dsh plugin --profile web add -w @dsheval/dsh-top100-plugin@1.3.4
```
...
pnpm dsh plugin --profile web add @dsheval/dsh-top100-plugin@1.3.4
pnpm dsh web
```
...
```sh
dsh plugin --profile web add @dsheval/dsh-top100-plugin@1.3.4
dsh web
```
