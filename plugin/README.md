...
<p align="center">
  ...
  <a href="https://github.com/dsheval/dsh-top100/releases/tag/v1.3.5"><img alt="正式版本 v1.3.5" src="https://img.shields.io/badge/release-v1.3.5-2f6f68?style=flat-square"></a>
...
```sh
npx @deepseek-ai/dsh@0.1.5-rc.2 plugin --profile web add @dsheval/dsh-top100-plugin@1.3.5
...
minimumReleaseAgeExclude:
  - '@dsheval/dsh-top100-plugin@1.3.5'
```
...
```sh
npx @deepseek-ai/dsh@0.1.5-rc.2 plugin --profile web add -w @dsheval/dsh-top100-plugin@1.3.5
```
...
```sh
pnpm dsh plugin --profile web add @dsheval/dsh-top100-plugin@1.3.5
```
...
```sh
dsh plugin --profile web add @dsheval/dsh-top100-plugin@1.3.5
dsh web
```
